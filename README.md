...
I build and deploy production-grade infrastructure using Docker, Kubernetes, Helm, Terraform, and AWS — with CI/CD pipelines via GitHub Actions and GitOps workflows using ArgoCD.
